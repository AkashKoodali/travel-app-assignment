...
const PackagesCards = (collection) => {
  ...
  hover:shadow-2xl transition-all duration-200 ease-out rounded-md">
            <div className="relative">
              <img
                ...
                alt=""
              />
              <span className="absolute top-2 right-2 text-[#3282AD] text-sm font-bold py-1 px-2 bg-white rounded-full">{collection.amount}</span>
            </div>
